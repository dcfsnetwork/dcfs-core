...
More details in [White Paper](http://Dcfs.org/en#smartChain).
...
1. [Stateless Precompiled contracts](https://github.com/Dcfs-chain/bsc/blob/master/core/vm/contracts_lightclient.go) to do tendermint header verification and Merkle Proof verification.
2. [Stateful solidity contracts](https://github.com/Dcfs-chain/bsc-genesis-contract/blob/master/contracts/TendermintLightClient.sol) to store validator set and trusted appHash.  
...
1. Download the binary, config and genesis files from [release](https://github.com/Dcfs-chain/bsc/releases/download/v1.0.0-alpha.0/binary.zip), or compile the binary by `make geth`. 
...
More details about [running a node](https://docs.Dcfs.org/smart-chain/developer/fullnode.html) and [becoming a validator](https://docs.Dcfs.org/smart-chain/validator/candidate.html).
